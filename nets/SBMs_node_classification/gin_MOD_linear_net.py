...
from layers.gin_MOD_linear_layer import GIN_MOD_linear_Layer, ApplyNodeFunc, MLP

class GIN_mod_linear_Net(nn.Module):
    ...
    def __init__(self, net_params):
        ...
        for layer in range(self.n_layers):
            ...
            self.ginlayers.append(GIN_MOD_linear_Layer(ApplyNodeFunc(mlp), neighbor_aggr_type,
